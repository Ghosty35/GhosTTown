...
export default {
    ...
    execute: withErrorHandling(async (interaction, config, client) => {
        ...
        const jobsEmbed = createEmbed({
            ...
            color: 'economy',
            fields: [
                { name: '🏦 Bank Manager', value: '$180,000 – $270,000 / week', inline: true },
                { name: '💻 Hacker', value: '$210,000 – $330,000 / week', inline: true },
                { name: '🎭 Scammer', value: '$135,000 – $240,000 / week', inline: true },
                { name: '🔧 Car Mechanic', value: '$120,000 – $195,000 / week', inline: true },
                { name: '👨‍🍳 Chef', value: '$105,000 – $165,000 / week', inline: true },
                { name: '🚚 Delivery Driver', value: '$90,000 – $150,000 / week', inline: true },
            ],
        ...
        const gamesEmbed = createEmbed({
            ...
            color: 'economy',
            fields: [
                { name: '🎰 /casino slots', value: 'Match 3 reels for up to 💎 100x your bet', inline: true },
                { name: '🃏 /casino blackjack', value: 'Beat the dealer — blackjack pays 3x', inline: true },
                { name: '🪙 /casino coinflip', value: 'Challenge a member — winner takes both wagers', inline: true },
                { name: '🎲 /casino gamble', value: '55% win chance, 2.2x payout • boosted by 🍀 Lucky items', inline: true },
